...
<body>
        ...
        <button class="user_profile_button">
          <a href="{{ route('logout') }}"
            onclick="event.preventDefault();
                     document.getElementById('logout-form').submit();" style="text-decoration: none;color: black">
            Logout
          </a>
        </button>
    ...
    <div class="map">
      <div class="mapdisp">
        <svg id="jatim_map" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3012.53 1638.06">
      		...
      		<g class="group excluded_area" id="Probolinggo">
      		...
      		<g class="group excluded_area" id="Sumenep">
 ...
 <script>
    ...
    $(function() {
      ...
      $('.cls, .group').not('.excluded_area').hover(function(e) {
      ...
      $('.cls, .group').not('.excluded_area').on('click', function(e) {
